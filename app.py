...
If you have relevant plant data from the database, prioritize that information in your responses."""
        ...
        try:
            ...
            if "tulsi" in query.lower():
                return jsonify({"message": "Tulsi (Holy Basil) is a sacred herb in Ayurveda known for boosting immunity, reducing stress, and treating respiratory issues like cold and cough. It's often consumed as tea or as fresh leaves. Always consult with a healthcare practitioner before using herbs for medicinal purposes.  \ud83c\udf3f"})
            elif "ashwagandha" in query.lower():
                return jsonify({"message": "Ashwagandha is an adaptogenic herb that helps reduce stress and anxiety, improve energy levels, and enhance overall vitality. It's typically taken as a powder or capsule. Consult with a healthcare practitioner before use. \ud83c\udf3f"})
            elif "neem" in query.lower():
                return jsonify({"message": "Neem is a powerful medicinal tree known for its antibacterial, antifungal, and blood-purifying properties. It's commonly used for skin conditions and oral health. Always consult with a healthcare practitioner before use. \ud83c\udf3f"})
            else:
                return jsonify({"message": "I'm VedaBot, your AI herbal assistant! I can help you learn about medicinal plants like Tulsi, Ashwagandha, Neem, and many more. Ask me about specific herbs, their benefits, or traditional uses. Remember to always consult with healthcare professionals for medical advice! \ud83c\udf3f"})
    except Exception as e:
